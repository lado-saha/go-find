...
import { fetchFilteredStolenItems as fetchFilteredStolenItems } from '@/app/lib/data';
import Status from '../common/status';
import { formatGeoString } from '@/app/lib/models';
...
export default async function SitesTable({
  ...
  const sites = await fetchFilteredStolenItems(query, sortBy, currentPage);
  return (
    <div className="mt-6 flow-root">
      <div className="min-w-full align-middle">
        <div className="mt-16 grid w-full grid-cols-1 gap-6 sm:grid-cols-1 lg:grid-cols-2">
